...
class hdfs_test():
    ...
    def expand_file(self):
        ...
        for i in range(imgs.shape[0]):
            ...
            with h5py.File(filename, 'w') as hdf:
                hdf.create_dataset('rgb', data=imgs[i])
                hdf.create_dataset('targets', data=targets[i])
    ...
    def test(self):
        ...
        files_list = os.listdir(self.saving_directory)
...
file_path = "/home/mohamed/Desktop/SeqVal/data_00000.h5"
saving_directory = "/home/mohamed/Desktop/test"
